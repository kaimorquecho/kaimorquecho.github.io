...
My analysis plan showed that the data did not meet the conditions required for an OLS model to fit - after plotting the residuals it is clear that there is no homoscedasticity in at least one of the data variables. It is also clear that there are non-linear relationships between predictors and the dependent variable.

The fitted model clearly exhibits omitted variable bias, though that does not come as a surprise given the size and characteristics of the dataset. There must be other predictors and interactions at play in the data

An OLS model was most definitely not the right fit for the dataset, or at the very least, not the right fit for the predictors I chose.
...
-   It would be helpful to incorporate the cost of living and the housing market of CA regions into the dataset
...
-   Including race in future analysis
